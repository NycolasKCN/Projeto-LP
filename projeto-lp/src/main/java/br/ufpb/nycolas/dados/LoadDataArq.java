...
public class LoadDataArq implements Data {
    private final String CAMINHO_APARELHO = "C:\\Scripts\\Java\\projetos\\Projeto-LP\\projeto-lp\\db\\AparelhosDB.txt";
    private final String CAMINHO_FUNCIONARIO = "C:\\Scripts\\Java\\projetos\\Projeto-LP\\projeto-lp\\db\\FuncionarioDB.txt";
    private final String CAMINHO_OS = "C:\\Scripts\\Java\\projetos\\Projeto-LP\\projeto-lp\\db\\OrdensDeServicoDB.txt";
